...
public class NPC : Agent {
	...
	public Action Plan(GameObject p_agent, List<Action> availableActions, HashSet<KeyValuePair<string,object>> currentWorldState, HashSet<KeyValuePair<string,object>> desiredWorldState) {
